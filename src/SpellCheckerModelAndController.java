...
/**
 * Created by NickDesktop on 3/18/2016.
 */
public class SpellCheckerModelAndController implements ISuggester {
    private Dictionary dict;
    final static String filePath = "src/resources/lilDict.csv";
    final static char[] alphabet = "abcdefghijklmnopqrstuvwxyz".toCharArray();

    SpellCheckerModelAndController() {
        dict = new Dictionary();
        dict.build(filePath);
    ...
    public static void main(String[] args) {
        SpellCheckerModelAndController sc = new SpellCheckerModelAndController();
        sc.run();
    }
